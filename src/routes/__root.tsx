...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Organize um encontro de casais inesquecível na sua igreja com 100 dinâmicas prontas, roteiro completo e bônus exclusivos." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "100 Dinâmicas para Encontro de Casais — Material Pronto para Igrejas" },
      { name: "twitter:description", content: "Organize um encontro de casais inesquecível na sua igreja com 100 dinâmicas prontas, roteiro completo e bônus exclusivos." },
